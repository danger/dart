...
//   factory DangerOutgoingMessages.fromRawJson(String str) =>
//       DangerOutgoingMessages.fromJson(json.decode(str));

//   String toRawJson() => json.encode(toJson());

//   factory DangerOutgoingMessages.fromJson(Map<String, dynamic> json) =>
//       DangerOutgoingMessages(
//         fails: json["fails"] == null
//             ? null
//             : List<Violation>.from(
//                 json["fails"].map((x) => Violation.fromJson(x))),
//         markdowns: json["markdowns"] == null
//             ? null
//             : List<Violation>.from(
//                 json["markdowns"].map((x) => Violation.fromJson(x))),
//         messages: json["messages"] == null
//             ? null
//             : List<Violation>.from(
//                 json["messages"].map((x) => Violation.fromJson(x))),
//         meta: json["meta"] == null ? null : Meta.fromJson(json["meta"]),
//         warnings: json["warnings"] == null
//             ? null
//             : List<Violation>.from(
//                 json["warnings"].map((x) => Violation.fromJson(x))),
//       );

//   Map<String, dynamic> toJson() => {
//         "fails": fails == null
//             ? null
//             : List<dynamic>.from(fails.map((x) => x.toJson())),
//         "markdowns": markdowns == null
//             ? null
//             : List<dynamic>.from(markdowns.map((x) => x.toJson())),
...
//   factory Violation.fromRawJson(String str) =>
//       Violation.fromJson(json.decode(str));
