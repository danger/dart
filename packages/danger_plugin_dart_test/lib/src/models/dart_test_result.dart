...
class DartTestResultClass {
    ...
    factory DartTestResultClass.fromRawJson(String str) => DartTestResultClass.fromJson(json.decode(str));
    ...
    factory DartTestResultClass.fromJson(Map<String, dynamic> json) => DartTestResultClass(
        ...
        messageType: json["messageType"] == null ? null : messageTypeValues.map[json["messageType"]],
