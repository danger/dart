...
void main() {
  group('danger_plugin_dart_test', () {
    ...
    test('should process success case correctly', () {
      ...
      DangerPluginDartTest.readFile(fixtureFile, workingDirectoryPath: '/Users/core/Documents/project/danger.dart/packages/danger_core');
    ...
    test('should process failure case correctly', () {
      ...
      expect(result.message, equals('''Test fail
Expected: <801>
  Actual: <80>
